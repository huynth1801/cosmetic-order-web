<?php 
  ...
  if(isset($_POST['submit'])) {
    ...
    $sql2 = "INSERT INTO tbl_order (cosmetic, price, qty, total, order_date, status, customer_name, customer_contact, customer_email, customer_address) VALUES ('$cosmetic', $price, $qty, $total, '$order_date', '$status', '$customer_name', '$customer_contact', '$customer_email', '$customer_address')";
        ...
        <form action="" class="order" method="post">
            <fieldset class="item-ordered">
                ...
                <?php 
                    ...
                    if($image_name == "") {
                      ...
                      ?>
                        <img src="<?php echo $image_name ?>" alt="Item1" class="img-responsive rounded-3 img-fluid" />
                    <?php 
                    }
                  ?>
                </div>
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <input type="tel" id="contact" name="contact" placeholder="E.g. 84123456" class="form-control input-responsive borderborder-dark border-1" required>
                </div>
                <div class="form-group">
